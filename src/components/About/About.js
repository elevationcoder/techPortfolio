        ...
        <div className={design.AboutMe} id="about">
            ...
            <div className={design.Container}>
                <div className={design.Text}>
                    ...
                    <p className={design.AboutParagraph}>
                ...
                <div className={design.Photo}>
                    <motion.img className={design.Me} src={"https://dochub.com/ian-t-marrs/mqNjP3BVWoMYJEPV9yGzLk/profile1-pic-jpg?dt=jdo4Qw_RKy4tJ1GJmYMa"} alt="myProfilePic"
